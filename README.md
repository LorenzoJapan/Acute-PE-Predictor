...
- `tests/test_flows.js` — a Playwright regression test driving the real UI through the PERC (low-probability) and YEARS-adjusted (moderate-probability) branches end to end (21 assertions). Run with `node tests/test_flows.js` (requires `playwright`).
